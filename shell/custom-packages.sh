...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES -dnsmasq dnsmasq-full kmod-nft-tproxy kmod-nft-socket kmod-nft-compat shadowsocks-rust luci-app-ssr-plus luci-i18n-ssr-plus-zh-cn"
