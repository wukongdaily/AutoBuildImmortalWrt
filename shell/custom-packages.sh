...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-nft-tproxy kmod-nft-socket iptables-mod-tproxy shadowsocks-rust-sslocal shadowsocksr-libev-ssr-check shadowsocksr-libev-ssr-local shadowsocksr-libev-ssr-redir simple-obfs-client lua-neturl luci-app-ssr-plus luci-i18n-ssr-plus-zh-cn"
