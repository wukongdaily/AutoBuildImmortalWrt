...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-nft-socket kmod-nft-tproxy sing-box luci-app-passwall2 luci-i18n-passwall2-zh-cn -v2ray-geoip -v2ray-geosite -sing-geolite2-geoip -sing-geosite"
