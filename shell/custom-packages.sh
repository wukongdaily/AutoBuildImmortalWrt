...
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-nft-socket kmod-nft-tproxy shadowsocks-rust-sslocal luci-app-passwall2 luci-i18n-passwall2-zh-cn -sing-box -xray-core"
...
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-nft-tproxy kmod-nft-socket kmod-nft-compat shadowsocks-rust luci-app-ssr-plus luci-i18n-ssr-plus-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES -dnsmasq dnsmasq-full kmod-nft-tproxy kmod-nft-socket kmod-nft-compat shadowsocks-rust-sslocal luci-app-ssr-plus luci-i18n-ssr-plus-zh-cn"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-nft-tproxy kmod-nft-socket iptables-mod-tproxy shadowsocks-rust-sslocal shadowsocksr-libev-ssr-local shadowsocksr-libev-ssr-redir simple-obfs-client lua-neturl luci-app-ssr-plus luci-i18n-ssr-plus-zh-cn"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-nft-tproxy kmod-nft-socket luci-app-ssr-plus luci-i18n-ssr-plus-zh-cn shadowsocks-rust-sslocal shadowsocksr-libev-ssr-check shadowsocksr-libev-ssr-local shadowsocksr-libev-ssr-redir simple-obfs-client lua-neturl iptables-mod-tproxy"
