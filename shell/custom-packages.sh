...
# 系统模块
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-mod-admin-full luci-mod-network luci-mod-status luci-mod-system  htop "
...
# 网络相关插件
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-firewall-zh-cn -luci-i18n-rtbwmon-zh-cn  -luci-i18n-watchdog-zh-cn"

# 工具类插件

CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-store  luci-app-ttyd -luci-app-wolplus luci-app-arpbind"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES -luci-i18n-poweroffdevice-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES -luci-i18n-wolplus-zh-cn luci-i18n-arpbind-zh-cn"
