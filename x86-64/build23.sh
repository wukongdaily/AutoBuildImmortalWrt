...
sed -i '/set network.lan.netmask/a\        set network.lan.gateway='\''192.168.2.200'\''' package/base-files/files/bin/config_generate
sed -i '/set network.lan.gateway/a\        set network.lan.dns='\''192.168.2.1'\''' package/base-files/files/bin/config_generate
